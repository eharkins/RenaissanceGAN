...
#this model doesn't work with new versions no no no
...
def makeGenerator(data_shape, noise_vect_size):
    ...
    generator.add(Conv2DTranspose(44, (1, 128), padding='same', input_shape = data_shape))
...
def makeDiscriminator(data_shape):
    ...
    discriminator.add(Conv2D(64, (4, 89), padding='same', input_shape=(data_shape), activation = 'relu'))
